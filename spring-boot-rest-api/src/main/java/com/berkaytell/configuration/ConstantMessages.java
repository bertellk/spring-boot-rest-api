...
// Birçok yerde kullanılacak şeyler tekrar tekrar yazmamak için buraya tanımlanabilir.
public class ConstantMessages {
    public final static String MESSAGE_SUCCESS = "İşlem Başarılı";
    ...
    public final static String USER_NOT_FOUND = "Kullanıcı Bulunamadı";
